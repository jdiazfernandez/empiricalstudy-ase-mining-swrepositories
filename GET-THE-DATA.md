...
The command `python src/mine/mine_harness.py --stratum all` also saves, alongside
`data/harness_P_raw.json`, `data/harness_G1_raw.json`, `data/harness_G2_raw.json`,
and `data/harness_G3_raw.json`, the full text of every
...
|---|---|---|---|
| `src/describe/prevalence.py` | `data/harness_P_raw.json`, `data/harness_G1_raw.json`, `data/harness_G2_raw.json`, `data/harness_G3_raw.json` | Section 4.2.1 Prevalence, 4.2.3 Breadth, 4.2.4 Co-occurrence, 4.2.5 Temporal adoption | For each mechanism (H1–H8 minus H4), what fraction of repositories have it, how many mechanisms co-occur per repository, and when each was first adopted. |
| `src/describe/mechanism_breakdown.py` | `data/harness_P_raw.json`, `data/harness_G1_raw.json`, `data/harness_G2_raw.json`, `data/harness_G3_raw.json` | Section 3.2.2 Deduplication (data cleansing) | Raw artifact counts before and after removing symlinks, undateable artifacts, and byte-identical duplicates. |
...
> **Note:** The precomputed file data/h5_zero_candidates.json is included in this repository. 
> No script in this package generates `data/h5_zero_candidates.json`.
...
> normative clauses in `data/harness_P_raw.json`, `data/harness_G1_raw.json`,
> `data/harness_G2_raw.json`, and `data/harness_G3_raw.json` (field
...
```bash
python src/describe/prevalence.py --raw data/harness_P_raw.json data/harness_G1_raw.json data/harness_G2_raw.json data/harness_G3_raw.json
