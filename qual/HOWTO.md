...
|---|---|---|---|---|---|
| **A** | H6 — structured consultation | `codebook_consultation.md` | one agent-authored text | 536 | `labels_coder1_full.csv`, `labels_coder2_full.csv` |
| **B** | RQ2 — rule-file content | `codebook_rulefiles.md` | one repository, whole corpus | 150 | `rulefiles_coder1_it1.csv`, `rulefiles_coder2_it1.csv`, `rulefiles_coder1_it2.csv`, `rulefiles_coder2_it2.csv` |
